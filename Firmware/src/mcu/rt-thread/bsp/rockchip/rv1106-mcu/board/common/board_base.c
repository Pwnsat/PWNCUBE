...
{
    /* CubeSat bring-up diag markers (TEMP, remove with the start_rv1106_mcu.S ones) */
    *(volatile unsigned int *)0xff6ff820 = 0xCAFE000A;
    rt_system_heap_init((void *)HEAP_BEGIN, (void *)HEAP_END);
    *(volatile unsigned int *)0xff6ff824 = 0xCAFE000B;
    rt_hw_interrupt_init();
    *(volatile unsigned int *)0xff6ff828 = 0xCAFE000C;
    rt_soft_interrupt_install(board_softirq_handler, RT_NULL, "soft irq");
    sysTick_config(SCR1_CORE_FREQUECY / RT_TICK_PER_SECOND);
    *(volatile unsigned int *)0xff6ff82c = 0xCAFE000D;
    /* initialize uart */
#ifdef RT_USING_UART
    rt_hw_usart_init();
#endif
...
#endif
    *(volatile unsigned int *)0xff6ff830 = 0xCAFE000E; /* board init done (TEMP) */
}
